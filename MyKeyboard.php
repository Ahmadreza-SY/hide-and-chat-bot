...
class Kbd
{
    ...
    static function create_glassy_link_btn($text, $url)
    {
        return [
            'text' => $text,
            'url'  => $url,
    ...
    static function create_glassy_keyboard($keyboard)
    {
        return Telegram\Bot\Keyboard\Keyboard::make(['inline_keyboard' => $keyboard]);
    }
    static function create_glassy_btn($text, $callback_function, $params = [])
    {
        $callback_data = [
            'f' => $callback_function,
        ];
    ...
    static function get_initial_keyboard()
    {
    ...
    static function get_keyboard($keyboard_name)
    {
        global $db;
    ...
    static function show_keyboard($keyboard_name, $text)
    {
    ...
    static function handle_button($message)
    {
